...
export const ui = {
  zh: {
    ...
    nav: { home: '首页', about: '关于', works: '作品', thoughts: '想法', diary: '日记' },
    hero: {
    ...
    home: {
      ...
      aboutCta: '了解更多',
      nowListeningEyebrow: 'Now Listening',
      nowListeningTitle: '最近在听',
      nowListeningEmpty: '最近还没有想记录的歌。',
      diaryLink: '听歌日记',
      journalEyebrow: '影像 · 日记',
      journalEmpty: '暂无影像或日记。',
      journalChipPhoto: '影像',
      journalChipText: '日记',
    ...
    diary: {
      title: '听歌日记',
      subtitle: '最近在听的歌，和一些当时的感受。',
      empty: '还没有公开的记录。',
      playOnNcm: '在网易云播放',
    },
    journal: {
      allTitle: '全部内容',
      allSubtitle: '音乐、代码、文字与影像，都收在这本日记里。',
      empty: '还没有公开的内容。',
      viewAll: '查看全部内容',
      sectionEyebrow: 'Journal',
      sectionTitle: '日记本',
      sectionSubtitle: '听过的歌、做的东西、写过的话，都贴在这里。',
      chips: {
        music: '音乐',
        code: '代码',
        post: '文章',
  ...
  en: {
    ...
    nav: { home: 'Home', about: 'About', works: 'Works', thoughts: 'Thoughts', diary: 'Diary' },
    hero: {
      role: 'software student · music maker · internet culture enjoyer',
      replay: 'Replay',
      scroll: 'SCROLL',
    ...
    home: {
      ...
      nowListeningEyebrow: 'Now Listening',
      nowListeningTitle: 'Now listening',
      nowListeningEmpty: 'No songs recorded yet.',
      diaryLink: 'Listening diary',
      journalEyebrow: 'Visual Diary',
      journalEmpty: 'No visual diary entries yet.',
      journalChipPhoto: 'Photo',
      journalChipText: 'Journal',
      worksEyebrow: 'Selected Works',
    ...
    diary: {
      ...
      subtitle: 'Songs I have been listening to, and how they felt.',
      empty: 'No public entries yet.',
      playOnNcm: 'Play on NetEase Music',
    },
    journal: {
      allTitle: 'All Entries',
      allSubtitle: 'Music, code, words and images — all kept in this journal.',
      empty: 'No public entries yet.',
      viewAll: 'View all entries',
      sectionEyebrow: 'Journal',
      sectionTitle: 'The Journal',
      sectionSubtitle: 'Songs, works and words — all pinned here.',
      chips: {
        music: 'Music',
        code: 'Code',
        post: 'Article',
