...
export const ui = {
  zh: {
    ...
    app: {
      ...
      text: '感想',
      photo: '照片',
      songHint: '粘贴网易云分享链接或文字，自动解析歌曲',
      resolve: '解析',
      resolving: '解析中…',
      resolveFail: '解析失败，请检查链接或手动填写',
      note: '备注（可选）',
      public: '公开',
      privateHint: '不勾选则仅自己可见',
      save: '保存',
      saved: '已保存',
      title: '标题',
      content: '写点什么…',
      photoHint: '拍照或选图（可多张，配文可选）',
      uploadFail: '上传失败',
      empty: '还没有记录，去记一笔吧',
      edit: '编辑',
      del: '删除',
  ...
  en: {
    ...
    app: {
      ...
      text: 'Note',
      photo: 'Photo',
      songHint: 'Paste a NetEase Music share link or text to auto-resolve the song',
      resolve: 'Resolve',
      resolving: 'Resolving…',
      resolveFail: 'Could not resolve. Check the link or fill in manually.',
      note: 'Note (optional)',
      public: 'Public',
      privateHint: 'Keep private if unchecked',
      save: 'Save',
      saved: 'Saved',
      title: 'Title',
      content: 'Write something…',
      photoHint: 'Take a photo or pick images (caption optional)',
